...
public class AllianceFlipUtil {
  ...
  public static Translation3d mirrorY(Translation3d translation) {
    return new Translation3d(
        translation.getX(), applyY(translation.getY()), translation.getZ());
  }
  ...
  public static Pose3d mirrorY(Pose3d pose) {
    return new Pose3d(mirrorY(pose.getTranslation()), apply(pose.getRotation()));
  }
